...
def update_task(request, task_id):
    ...
    return render(request, 'bboard/update_task.html', {'form': form, 'task': task})
...
def select_columns_view(request):
    ...
    context = {'tasks': selected_columns}
    return render(request, 'bboard/selected_columns.html', context)

def exclude_tasks_view(request):
    excluded_tasks = Task.objects.exclude(description__icontains='ЗАПИСЬ')
    context = {'tasks': excluded_tasks}
    return render(request, 'bboard/excluded_tasks.html', context)